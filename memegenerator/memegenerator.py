...
def make_meme(topString, bottomString, filename, folder, newName):
	...
	fontLocation = os.path.abspath(folder)
	font = ImageFont.truetype(fontLocation + "/impactreg.ttf", fontSize)
